class Ohq < ActiveRecord::Base
	...
	validates_presence_of :q1, :q2, :q3, :q4, :q5, :q6, :q7, :q8, :q9, :q10, unless: :score?
	validates_presence_of :q11, :q12, :q13, :q14, :q15, :q16, :q17, :q18, :q19, :q20, unless: :score?
	validates_presence_of :q21, :q22, :q23, :q24, :q25, :q26, :q27, :q28, :q29, unless: :score?
	...
	private
		...
		def save_score
			...
			average = sum / 29
			self.score = (average * 100 / 6).round
		end
end
